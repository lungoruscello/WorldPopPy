"""
Example 1: Visualise night-light emissions for the Korean Peninsula.
...
# Fetch night-light (NTL) data for the Korean Peninsula.
# Note: `wp-raster` returns an `xarray.DataArray` ready for analysis and plotting.
